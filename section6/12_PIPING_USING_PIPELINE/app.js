...
// pipe method error ko handle nhi karta hai incase error ajati hai toh
// aur agar error aaaje toh alag sai eror ka use karo


// readstream.on("error",(err)=>{
//     console.log(err);
// });// yeh usee karne sai acha hum pipeline function ka use karte hai



// yeh pipeline stream module sai export hota hai ek line mai eeror handle hojata hai
//syntax below
